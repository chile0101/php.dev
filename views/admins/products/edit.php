...
<div class="container">
  ...
  <form method="POST" action="<?php $_SERVER['PHP_SELF'] ?>">
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-6">
        <input type="number" name="price"  min="1" max="1000" style="width:100px ;margin-right:5px;" value="<?php echo $viewmodel['price'] ?>"> $
      </div>
      <div class="col-sm-3">
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-6">
        <textarea  class="form-control" name="description" value="<?php echo $viewmodel['description'] ?>" ></textarea>
