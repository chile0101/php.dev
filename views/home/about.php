...
<section class="our-team">
	<div class="container">
		<div class="row">
			<div class="col-sm-12">
				<div class="video-box">
					<h1 class="team-title font-alt">MEET OUR TEAM</h1>
					<div class="team-subtitle font-serif">An awesome way to introduce the members of your team.</div>
				</div>
			</div>
		</div>
	</div>
...
<section class="module about-page-vide bg-dark" style="background-image: url('<?php echo ROOT_PATH;?>assets/images/about/about-page.jpg');" data-background="<?php echo ROOT_PATH;?>assets/images/about/about-page.jpg">
	<div class="container">
		<div class="row">
			<div class="col-sm-12">
				<div class="video-box">
					<h1 class="video-title font-alt">PRESENTATION</h1>
					<div class="video-subtitle font-serif">THE VIDEO ABOUT OUR NEW PRODUCTS</div>
				</div>
			</div>
		</div>
	</div>
