				...
				<tbody>
					<?php foreach ($viewmodel[0] as $product) : ?>
						<tr>
							...
							<td><a href="<?php echo ROOT_URL.'home/detail/'.$product['id']; ?>"><img width="100" height="100" src="<?php echo ROOT_PATH.$product['image'];?> " alt="product"></a></td>
							<td><a href="<?php echo ROOT_URL.'home/detail/'.$product['id']; ?>"><?php echo $product['name'];?></a></td>
	...
	<div class="cart-totals">
		...
		<div class="row">
			...
			<?php if(isset($_SESSION['user_logged_in'])){
				echo ROOT_URL.'cart/checkout'; 
			}else{
				echo ROOT_URL.'auth/login'; 
			} 
